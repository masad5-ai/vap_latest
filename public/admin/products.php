...
<section class="section admin-dual">
    <div class="panel">
        ...
        <form method="post" class="stacked">
            ...
            <label>Sale price <input type="number" step="0.01" name="sale_price"></label>
            <label>Promo badge <input name="promo"></label>
    ...
    <div class="panel">
        ...
        <div class="stacked">
            ...
            <label>Sale price <input type="number" step="0.01" name="sale_price" value="<?= htmlspecialchars($product['sale_price'] ?? '') ?>"></label>
            <label>Promo badge <input name="promo" value="<?= htmlspecialchars($product['promo'] ?? '') ?>"></label>
