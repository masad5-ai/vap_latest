...
$quickLinks = [
    ['title' => 'Configure shipping', 'description' => 'Adjust courier labels, ETAs, and prices', 'href' => '/admin/shipping.php'],
    ['title' => 'Payment gateways', 'description' => 'Update merchant IDs and checkout copy', 'href' => '/admin/payments.php'],
    ['title' => 'Messaging stack', 'description' => 'Email + WhatsApp templates and API keys', 'href' => '/admin/notifications.php'],
    ['title' => 'Add new product', 'description' => 'Launch a device, pod, or flavor drop', 'href' => '/admin/products.php'],
    ['title' => 'Invite staff', 'description' => 'Promote team to admin and control access', 'href' => '/admin/users.php'],
];
...
<section class="section admin-dual">
    ...
    <div class="panel">
        <div class="section-header compact">
            ...
            <a class="button ghost" href="/admin/shipping.php">Edit</a>
        </div>
